module.exports = {
    ...
    pullPrevious: {
        command: `lftp -d -e 'set sftp:auto-confirm yes; mirror Shared/FW/Knutsford/Digital/Auto-Regression/<%= pkg.name %>/<%= repo.name %> .tmp/previous -p -e --parallel=10 -c; exit;' -u '<%= targets.ftp["ftp-fishawack.egnyte.com"].username %>',<%= targets.ftp["ftp-fishawack.egnyte.com"].password %> sftp://ftp-fishawack.egnyte.com`,
        options: {
            failOnError: false
        }
    }
