...
describe('veeva', () => {
    ...
    describe('sharedResource', () => {
        ...
        describe('generated', () => {
            before(() => {
                execSync('mkdir -p _Test/build/_fixture/package/_Output/shared');
                execSync('touch _Test/build/_fixture/package/_Output/shared/shared.css');
                execSync('grunt clean:veeva veeva --branch=veeva-shared-resource --mocha=package', opts);
            });
            ...
            it('Should contain a dummy thumb.png and index.html inside the veeva_shared_resorce.zip file', () => {
                execSync('unzip _Test/build/_fixture/package/_Packages/Veeva/veeva_shared_resource.zip -d _Test/build/_fixture/package/_Packages/Veeva/veeva_shared_resource');
            ...
            after(() => {
                execSync('rm -rf _Test/build/_fixture/package/_Output/shared');
            });
        });
    });
