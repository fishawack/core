module.exports = function(grunt) {
    ...
    grunt.registerTask('default', ['env:dev', 'karma:unit:start', 'badges', 'jshint', 'modernizr', 'tv4', 'browserify:dev', 'concat:dev', 'fontello_svg', 'svgfit', 'svgmin', 'svg_sprite', 'copy', 'compile-handlebars:dev', 'htmlmin', 'sass:dev', 'postcss:all', 'clean:build', 'browserSync', 'connect', 'watch']);
    
    grunt.registerTask('dist', ['env:stage', 'clean:dist', 'badges', 'jshint', 'modernizr', 'tv4', 'browserify:dist', 'concat:dist', 'uglify:dist', 'fontello_svg', 'svgfit', 'svgmin', 'svg_sprite', 'copy', 'compile-handlebars:dist', 'htmlmin', 'sass:dist', 'postcss:all', 'imagemin', 'clean:build']);
